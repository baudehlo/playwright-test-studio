    ...
    <ThemeProvider>
      <Router>
        ...
        <Helmet>
          ...
          <meta name="description" content="Write automated browser tests in plain English. Playwright Test Studio uses AI to translate natural language into robust Playwright test scripts. No coding required." />
        </Helmet>
