...
import { Bot, Cpu, Sparkles, Brain, Network } from 'lucide-react';
...
const AIProviderBadge = ({ name, href }) => {
  ...
  const BadgeContent = (
    <Badge variant="outline" className="px-3 py-1.5 flex items-center gap-2 hover:bg-secondary transition-colors cursor-pointer bg-background text-foreground border-border hover:border-border/80">
